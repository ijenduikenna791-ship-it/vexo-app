    ...
    <main className="max-w-md mx-auto min-h-screen pb-28 px-4 pt-6 flex flex-col gap-5">
      ...
      <div className="flex flex-col items-center text-center gap-3 py-10">
        <div className="w-14 h-14 rounded-full bg-vexo-card2 flex items-center justify-center">
          <IconHeadset size={26} className="text-vexo-orange" />
        </div>
        <p className="font-bold text-lg">Support Center</p>
        <p className="text-vexo-muted text-sm max-w-xs">Viewing and responding to user support tickets requires a real backend. This page is a placeholder until that's connected.</p>
      </div>
    </main>
  );
}
