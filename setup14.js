...
const countries = [
  ...
  { name: "China", code: "cn", dial: "+86", placeholder: "138 0013 8000" },
  { name: "Singapore", code: "sg", dial: "+65", placeholder: "8123 4567" },
  { name: "United Arab Emirates", code: "ae", dial: "+971", placeholder: "50 123 4567" },
  { name: "Saudi Arabia", code: "sa", dial: "+966", placeholder: "50 123 4567" },
  { name: "Egypt", code: "eg", dial: "+20", placeholder: "100 123 4567" },
  { name: "Turkey", code: "tr", dial: "+90", placeholder: "501 234 56 78" },
  { name: "Philippines", code: "ph", dial: "+63", placeholder: "917 123 4567" },
  { name: "Indonesia", code: "id", dial: "+62", placeholder: "812 3456 789" },
  { name: "Vietnam", code: "vn", dial: "+84", placeholder: "91 234 56 78" },
  { name: "Poland", code: "pl", dial: "+48", placeholder: "512 345 678" },
  { name: "Ireland", code: "ie", dial: "+353", placeholder: "85 123 4567" },
              ...
              <div className="relative mt-2">
                {selectedCountry && (
                  <span className="absolute left-3.5 top-1/2 -translate-y-1/2 pointer-events-none">
                    <Flag code={selectedCountry.code} size={22} />
                  </span>
                )}
                <select
                  value={form.country}
                  ...
                  required
                  className={\`w-full bg-vexo-card border border-vexo-border rounded-xl py-3 pr-4 text-sm outline-none focus:border-vexo-orange appearance-none \${selectedCountry ? "pl-11" : "pl-4"}\`}
                >
            ...
            <div>
              ...
              <div className="flex mt-2">
                <span className="flex items-center gap-1.5 bg-vexo-card2 border border-vexo-border border-r-0 rounded-l-xl px-3 text-sm text-vexo-muted whitespace-nowrap">
                  ...
                  {selectedCountry ? selectedCountry.dial : "+__"}
                </span>
                <input
                  type="tel"
...
console.log("\\nDone! Country and phone fields now show real flag images (via flagcdn.com) instead of emoji, which render properly on Windows.");
